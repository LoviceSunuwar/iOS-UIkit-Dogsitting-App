...
class WalkersListTableViewCell: UITableViewCell {
    ...
    func setWalkerListCell(walkerListObj:WalkersList)
    {
        walkerImage.image = UIImage(systemName: walkerListObj.walkerImage)
        walkerName.text = walkerListObj.walkerName
        rating.text = walkerListObj.rating
        walkerBio.text = walkerListObj.walkerBio
